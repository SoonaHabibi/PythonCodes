# -*- coding: utf-8 -*-
"""
Created on Thu Oct 15 10:00:01 2020
...
lonAr = np.array([-119.659,-119.626,-119.587])
latAr = np.array([34.47, 34.47,34.47])

BegDate = datetime(1981,1,1)
EndDate = datetime(2020,3,26)
Res = '4km'
Var = 'ppt'
...
outfile = '//westfolsom/Projects/2020/Meyers Nave/PRISM/'+Var+'_Prism.csv'
statfile = '//westfolsom/Projects/2020/Meyers Nave/PRISM/'+Var+'_stat_Prism.csv'
